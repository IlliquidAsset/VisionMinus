...
| Integration | Amanda | INTEGRATING | Nia safety output and product candidate `815aa680` require independent review | Small reviewed merges, full tests/build, phone verification | Release candidate only after end-to-end evidence |
