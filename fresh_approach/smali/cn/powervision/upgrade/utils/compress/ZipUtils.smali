.class Lcn/powervision/upgrade/utils/compress/ZipUtils;
...
.method public static getEntriesNames(Ljava/io/File;)Ljava/util/ArrayList;
    ...
    check-cast v1, Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;

    .line 140
    new-instance v2, Ljava/lang/String;

    invoke-static {v1}, Lcn/powervision/upgrade/utils/compress/ZipUtils;->getEntryName(Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;)Ljava/lang/String;
...
.method public static getEntryComment(Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;->getComment()Ljava/lang/String;
...
.method public static unzipFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 94
    new-instance p0, Lcn/powervision/upgrade/utils/compress/tool/ZipInputStream;

    new-instance v1, Ljava/io/BufferedInputStream;

    invoke-direct {v1, v0}, Ljava/io/BufferedInputStream;-><init>(Ljava/io/InputStream;)V

    invoke-direct {p0, v1}, Lcn/powervision/upgrade/utils/compress/tool/ZipInputStream;-><init>(Ljava/io/InputStream;)V

    .line 97
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lcn/powervision/upgrade/utils/compress/tool/ZipInputStream;->getNextEntry()Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;
    ...
    .line 100
    invoke-virtual {v0}, Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;->getName()Ljava/lang/String;

    move-result-object v3

    .line 101
    invoke-virtual {v0}, Lcn/powervision/upgrade/utils/compress/tool/ZipEntry;->isDirectory()Z
    ...
    .line 117
    :goto_1
    invoke-virtual {p0, v2, v4, v1}, Lcn/powervision/upgrade/utils/compress/tool/ZipInputStream;->read([BII)I
    ...
    .line 124
    :cond_4
    invoke-virtual {p0}, Lcn/powervision/upgrade/utils/compress/tool/ZipInputStream;->close()V
...
.method private static zipFile(Ljava/io/File;Ljava/util/zip/ZipOutputStream;Ljava/lang/String;)V
    ...
    .line 198
    invoke-static {v3, p1, v0}, Lcn/powervision/upgrade/utils/compress/ZipUtils;->zipFile(Ljava/io/File;Ljava/util/zip/ZipOutputStream;Ljava/lang/String;)V
...
.method public static zipFiles(Ljava/util/Collection;Ljava/io/File;)V
    ...
    .line 47
    invoke-static {p1, v1, v0}, Lcn/powervision/upgrade/utils/compress/ZipUtils;->zipFile(Ljava/io/File;Ljava/util/zip/ZipOutputStream;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
