...
.method public request()V
    ...
    invoke-static {v2}, Lorg/xutils/http/HttpTask;->access$200(Lorg/xutils/http/HttpTask;)Ljava/lang/reflect/Type;
    ...
    .line 595
    iget-object v1, p0, Lorg/xutils/http/HttpTask$RequestWorker;->this$0:Lorg/xutils/http/HttpTask;
    ...
    :cond_2
    :try_start_7
    iget-object v0, p0, Lorg/xutils/http/HttpTask$RequestWorker;->this$0:Lorg/xutils/http/HttpTask;

    invoke-static {v0}, Lorg/xutils/http/HttpTask;->access$500(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/request/UriRequest;

    move-result-object v0

    iget-object v1, p0, Lorg/xutils/http/HttpTask$RequestWorker;->this$0:Lorg/xutils/http/HttpTask;

    invoke-static {v1}, Lorg/xutils/http/HttpTask;->access$400(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/app/RequestInterceptListener;
    ...
    iput-object v0, p0, Lorg/xutils/http/HttpTask$RequestWorker;->result:Ljava/lang/Object;
    :try_end_7
    ...
    .line 603
    :try_start_8
    iput-object v0, p0, Lorg/xutils/http/HttpTask$RequestWorker;->ex:Ljava/lang/Throwable;

    .line 606
    :goto_2
    iget-object v0, p0, Lorg/xutils/http/HttpTask$RequestWorker;->ex:Ljava/lang/Throwable;
    :try_end_8
    ...
    invoke-static {v1}, Lorg/xutils/http/HttpTask;->access$200(Lorg/xutils/http/HttpTask;)Ljava/lang/reflect/Type;
    ...
    invoke-static {v3}, Lorg/xutils/http/HttpTask;->access$600(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/RequestParams;
    ...
    invoke-static {v4}, Lorg/xutils/http/HttpTask;->access$500(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/request/UriRequest;
    ...
    invoke-static {v4}, Lorg/xutils/http/HttpTask;->access$600(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/RequestParams;
    ...
    invoke-static {v4, v3}, Lorg/xutils/http/HttpTask;->access$602(Lorg/xutils/http/HttpTask;Lorg/xutils/http/RequestParams;)Lorg/xutils/http/RequestParams;
    ...
    invoke-static {v4}, Lorg/xutils/http/HttpTask;->access$700(Lorg/xutils/http/HttpTask;)Lorg/xutils/http/request/UriRequest;

    move-result-object v4

    invoke-static {v3, v4}, Lorg/xutils/http/HttpTask;->access$502(Lorg/xutils/http/HttpTask;Lorg/xutils/http/request/UriRequest;)Lorg/xutils/http/request/UriRequest;
