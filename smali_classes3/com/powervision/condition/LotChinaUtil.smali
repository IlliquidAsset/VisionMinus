.class public Lcom/powervision/condition/LotChinaUtil;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/powervision/condition/LotChinaUtil$Rectangle;
    }
.end annotation


# static fields
.field private static volatile lotChinaUtil:Lcom/powervision/condition/LotChinaUtil;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/powervision/condition/LotChinaUtil;->regionRectangle:Ljava/util/List;

    .line 15
    new-instance v11, Lcom/powervision/condition/LotChinaUtil$Rectangle;
    ...
    invoke-direct/range {v1 .. v10}, Lcom/powervision/condition/LotChinaUtil$Rectangle;-><init>(Lcom/powervision/condition/LotChinaUtil;DDDD)V

    invoke-interface {v0, v11}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 16
    iget-object v0, p0, Lcom/powervision/condition/LotChinaUtil;->regionRectangle:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/powervision/condition/LotChinaUtil;->excludeRecangle:Ljava/util/List;
    ...
    .line 24
    iget-object v0, p0, Lcom/powervision/condition/LotChinaUtil;->excludeRecangle:Ljava/util/List;
...
.method public static getInstance()Lcom/powervision/condition/LotChinaUtil;
    .locals 1

    .line 32
    sget-object v0, Lcom/powervision/condition/LotChinaUtil;->lotChinaUtil:Lcom/powervision/condition/LotChinaUtil;

    if-nez v0, :cond_0

    .line 33
    new-instance v0, Lcom/powervision/condition/LotChinaUtil;

    invoke-direct {v0}, Lcom/powervision/condition/LotChinaUtil;-><init>()V

    sput-object v0, Lcom/powervision/condition/LotChinaUtil;->lotChinaUtil:Lcom/powervision/condition/LotChinaUtil;
...
.method private inRectangle(Lcom/powervision/condition/LotChinaUtil$Rectangle;DD)Z
    .locals 3

    .line 55
    iget-wide v0, p1, Lcom/powervision/condition/LotChinaUtil$Rectangle;->West:D

    cmpg-double v2, v0, p2

    if-gtz v2, :cond_0

    iget-wide v0, p1, Lcom/powervision/condition/LotChinaUtil$Rectangle;->East:D

    cmpl-double v2, v0, p2

    if-ltz v2, :cond_0

    iget-wide p2, p1, Lcom/powervision/condition/LotChinaUtil$Rectangle;->North:D

    cmpl-double v0, p2, p4

    if-ltz v0, :cond_0

    iget-wide p1, p1, Lcom/powervision/condition/LotChinaUtil$Rectangle;->South:D
...
.method public isInsideChina(DD)Z
    ...
    .line 40
    :goto_0
    iget-object v2, p0, Lcom/powervision/condition/LotChinaUtil;->regionRectangle:Ljava/util/List;
    ...
    check-cast v4, Lcom/powervision/condition/LotChinaUtil$Rectangle;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/powervision/condition/LotChinaUtil;->inRectangle(Lcom/powervision/condition/LotChinaUtil$Rectangle;DD)Z
    ...
    .line 42
    :goto_1
    iget-object v2, p0, Lcom/powervision/condition/LotChinaUtil;->excludeRecangle:Ljava/util/List;
